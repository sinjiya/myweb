...
<html>
    ...
    <body>
        ...
        <div id="show-chapter" class="content scaffold-show" role="main">
            ...
            <f:display bean="chapter" />
            <g:form resource="${this.chapter}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.chapter}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
